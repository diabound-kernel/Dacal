...
{
    template<class T>
    struct [[maybe_unused]] vector_iterator : dacal::base_iterator<dacal::random_access_iterator_tag  , T , std::size_t , T*, T&>
    {
        ...
        [[maybe_unused]] vector_iterator::difference_type operator-(const vector_iterator &rhs)
        {
    ...
    template<class T>
    struct [[maybe_unused]] const_vector_iterator : dacal::base_iterator<dacal::random_access_iterator_tag  , T , std::size_t , T*, T&>
    {
        using typename dacal::base_iterator<dacal::random_access_iterator_tag  , T , std::size_t , T*, T&>::iterator_category;
        using typename dacal::base_iterator<dacal::random_access_iterator_tag  , T , std::size_t , T*, T&>::value_type;
        using typename dacal::base_iterator<dacal::random_access_iterator_tag  , T , std::size_t , T*, T&>::difference_type;
        ...
        [[maybe_unused]] const_vector_iterator::difference_type operator-(const const_vector_iterator &rhs)
        {
            return this->_ptr - rhs._ptr;
        }
...
namespace dacal
{
    ...
    {
        auto _tmp_buffer = std::allocator_traits<allocator>::allocate(_allocator, _new_capacity);
    ...
    template<class T , class Allocator>
    [[maybe_unused]] vector<T , Allocator>::vector(const std::initializer_list<T> &_initializer)
    {
    ...
    {
        this->_data = std::allocator_traits<allocator>::allocate(_allocator, _other._capacity);
    ...
    template<class T , class Allocator>
    [[maybe_unused]] vector<T , Allocator> &vector<T , Allocator>::operator=(const vector &_other)
    {
        if (this != &_other)
        {
            this->_data = std::allocator_traits<allocator>::allocate(_allocator, _other._capacity);
    ...
    template<class T , class Allocator>
    [[maybe_unused]] vector<T , Allocator> &vector<T , Allocator>::operator=(vector &&_other) noexcept
    {
        _capacity = dacal::exchange(_other._capacity , 0);
        _size     = dacal::exchange(_other._size     , 0);
        _data     = dacal::exchange(_other._data     , nullptr);
    ...
    template<class T , class Allocator>
    [[maybe_unused]] typename vector<T  , Allocator>::reference vector<T , Allocator>::operator[](std::size_t _offset)
    {
        return _data[_offset];
    }

    template<class T , class Allocator>
    [[maybe_unused]] typename vector<T , Allocator>::const_reference vector<T, Allocator>::operator[](std::size_t _offset) const
    {
        return _data[_offset];
    }

    template<class T , class Allocator>
    [[maybe_unused]] typename vector<T , Allocator>::iterator vector<T , Allocator>::begin()
    {
        return dacal::vector<T , Allocator>::iterator(_data);
    }

    template<class T , class Allocator>
    [[maybe_unused]] typename vector<T , Allocator>::iterator vector<T , Allocator>::end()
    {
        return dacal::vector<T, Allocator>::iterator(_data + _size);
    }

    template<class T , class Allocator>
    [[maybe_unused]] typename vector<T , Allocator>::reverse_iterator vector<T , Allocator>::rbegin()
    {
        return dacal::vector<T , Allocator>::reverse_iterator(iterator(_data + (_size - 1)));
    }

    template<class T , class Allocator>
    [[maybe_unused]] typename vector<T , Allocator>::reverse_iterator vector<T , Allocator>::rend()
    {
        return dacal::vector<T , Allocator>::reverse_iterator(iterator(_data - 1));
    }

    template<class T , class Allocator>
    [[maybe_unused]] typename vector<T , Allocator>::const_iterator vector<T , Allocator>::cbegin()
    {
        return dacal::vector<T , Allocator>::const_iterator(_data);
    }

    template<class T , class Allocator>
    [[maybe_unused]] typename vector<T , Allocator>::const_iterator vector<T , Allocator>::cend()
    {
        return dacal::vector<T , Allocator>::const_iterator(_data + _size);
    }

    template<class T , class Allocator>
    [[maybe_unused]] void vector<T , Allocator>::push_back(typename vector<T , Allocator>::const_reference data)
    {
        if (_size >= _capacity)
        {
    ...
    template<class T , class Allocator>
    [[maybe_unused]] [[nodiscard]] typename vector<T , Allocator>::value_type vector<T , Allocator>::pop_back()
    {
    ...
    template<class T , class Allocator>
    [[maybe_unused]] [[nodiscard]] typename vector<T , Allocator>::value_type vector<T , Allocator>::pop_front()
    {
