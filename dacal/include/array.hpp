...
namespace detail {
template<class T>
struct [[maybe_unused]] array_iterator : dacal::base_iterator<
                                             ...
                                             T &>
{
    ...
    [[maybe_unused]] array_iterator::difference_type
    operator-(const array_iterator &rhs)
    {
...
template<class T>
struct [[maybe_unused]] const_array_iterator
    : dacal::base_iterator<
          dacal::random_access_iterator_tag,
          T,
          std::size_t,
          ...
          T &>
{
    ...
    [[maybe_unused]] const_array_iterator::difference_type
    operator-(const const_array_iterator &rhs)
    {
        return this->_ptr - rhs._ptr;
    }
...
template<typename T, std::size_t N>
[[maybe_unused]] typename array<T, N>::reference
array<T, N>::operator[](std::size_t offset)
{
...
template<typename T, std::size_t N>
[[maybe_unused]] void
array<T, N>::push_back(typename array<T, N>::const_reference data)
{
    if (_len < _size) {
        _buffer[_len++] = data;
    }
...
template<typename T, std::size_t N>
[[maybe_unused]] [[nodiscard]] typename array<T, N>::value_type
array<T, N>::pop_back()
{
