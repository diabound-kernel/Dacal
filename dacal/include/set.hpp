...
namespace dacal
{
    template< class T , class Compare = dacal::less<T> , class Allocator = std::allocator<T> >
    ...
    private:
        [[maybe_unused]] void _insert(detail::rb_tree_node<T> *&_node, detail::rb_tree_node<T> *_parent, detail::rb_tree_node<T> *new_node);
        ...
        [[maybe_unused]] detail::rb_tree_node<value_type> *_find(detail::rb_tree_node<value_type> *node, const_reference data);
    ...
    [[maybe_unused]] void
    set<T, Compare , Allocator>::_insert(detail::rb_tree_node<T> *&_node, detail::rb_tree_node<T> *_parent, detail::rb_tree_node<T> *new_node)
    {
        if (_node == nullptr) {
            _node = new_node;
            _node->_parent = _parent;
        } else {
            if (_compare(new_node->_data, _node->_data)) {        // less(_data , _node->_data) or greater(_data , _node->_data)
                _insert(_node->_left_child, _node, new_node);
            } else if (_compare(_node->_data, new_node->_data)) { // less(_node->_data , _data) or greater(_node->_data , _data)
    ...
    template<class T, class Compare , class Allocator>
    [[maybe_unused]] void set<T, Compare , Allocator>::_fix_insert(detail::rb_tree_node<T> *node)
    {
    ...
    template<class T, class Compare , class Allocator>
    [[maybe_unused]] void set<T, Compare , Allocator>::_rotateRight(detail::rb_tree_node<T> *node)
    {
    ...
    template<class T, class Compare , class Allocator>
    [[maybe_unused]] void set<T, Compare , Allocator>::_rotateLeft(detail::rb_tree_node<T> *node)
    {
    ...
    template<class T, class Compare , class Allocator>
    [[maybe_unused]] detail::rb_tree_node<typename set<T , Compare , Allocator>::value_type>*
    set<T, Compare , Allocator>::_find(detail::rb_tree_node<value_type> *node, const_reference data)
    {
    ...
    template<class T, class Compare , class Allocator>
    [[maybe_unused]] set<T, Compare , Allocator>::set(const std::initializer_list<T> &_initializer)
    {
    ...
    {
        for (set<T, Compare , Allocator>::iterator i = _other.begin(); i != _other.end(); ++i) {
            this->insert(*i);
        }
    }
    ...
    template<class T, class Compare , class Allocator>
    [[maybe_unused]] set<T, Compare , Allocator> &set<T, Compare , Allocator>::operator=(const set& _other)
    {
        if (this != &_other)
        {
            for (set<T, Compare , Allocator>::iterator i = _other.begin(); i != _other.end(); ++i) {
    ...
    template<class T, class Compare , class Allocator>
    [[maybe_unused]] set<T, Compare , Allocator> &set<T, Compare , Allocator>::operator=(set&& _other) noexcept
    {
        this->_root_of_tree = dacal::exchange(_other._root_of_tree, nullptr);
        return *this;
    }
    ...
    template<class T, class Compare , class Allocator>
    [[maybe_unused]] typename set<T , Compare , Allocator>::iterator set<T, Compare , Allocator>::begin() const
    {
        return set::iterator(detail::rb_tree_node<T>::_leftmost_node(_root_of_tree));
    }

    template<class T, class Compare , class Allocator>
    [[maybe_unused]] typename set<T , Compare , Allocator>::iterator set<T, Compare , Allocator>::end() const
    {
        return set::iterator(nullptr);
    }

    template<class T, class Compare , class Allocator>
    [[maybe_unused]] typename set<T , Compare , Allocator>::reverse_iterator set<T, Compare , Allocator>::rbegin() const
    {
        return set::reverse_iterator(set::iterator(detail::rb_tree_node<T>::_rightmost_node(_root_of_tree)));
    }

    template<class T, class Compare , class Allocator>
    [[maybe_unused]] typename set<T , Compare , Allocator>::reverse_iterator set<T, Compare , Allocator>::rend() const
    {
        return set::reverse_iterator(set::iterator(nullptr));
    }

    template<class T, class Compare , class Allocator>
    [[maybe_unused]] void set<T, Compare , Allocator>::insert(set::const_reference _data)
    {
